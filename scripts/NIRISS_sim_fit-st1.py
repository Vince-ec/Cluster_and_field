...
GS = Gen_spec_NIRISS_sim(specz, wave, flam, Iused = ['F150W','F200W'], Fused = ['F150W','F200W'], random_seed = rnd)
...
np.save(out_path + 'NIRISS_sim_st1_z{}_t{}_r{}'.format(specz, tau, rnd), dres) 
...
np.save(pos_path + 'NIRISS_sim_st1_z{}_t{}_r{}'.format(specz, tau, rnd),fit_dict)
