...
lbt, sfh = np.load(data_path + 'sim_SFH/SFH_z{}_{}_LsSFR_{}.npy'.format(specz, galaxy, num),allow_pickle = True)
...
if not os.path.isfile(out_path + 'z{}_{}_LsSFR_{}_Ifit_imp'.format(specz, galaxy, num)):
    ...
    np.save(out_path + 'z{}_{}_LsSFR_{}_Ifit_imp'.format(specz, galaxy, num), dres) 
    
else:
    dres = np.load(out_path + 'z{}_{}_LsSFR_{}_Ifit_imp.npy'.format(specz, galaxy, num), allow_pickle = True).item()
...
np.save(pos_path + 'z{}_{}_LsSFR_{}_Ifit_impfits'.format(specz, galaxy, num),fit_dict)
