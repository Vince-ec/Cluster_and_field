...
def loglikelihood(X):
    ...
    sp.params['dust2'] = d
    sp.set_tabular_sfh(np.array([0.1, 0.5, 1, 2, 4, 7]),np.array([t1, t2, t3, t4, t5, t6]))
...
dsampler = dynesty.DynamicNestedSampler(loglikelihood, prior_transform, ndim = 10, sample = 'rwalk', bound = 'single') 
