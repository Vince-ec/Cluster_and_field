...
if SFa == 'Q':
    ...
    def Galfit_L(X):
        ...
        Gmfl = Full_forward_model_3(Gs, wave, F_lam_per_M(flux,wave*(1 + specz), specz, 0, sp.stellar_mass)*10**lm, specz, 
                                        wvs, flxs, errs, beams, trans)
...
np.save(out_path + 'z{}_{}_Ifit_imp_grism'.format(specz, galaxy), dres) 
...
np.save(pos_path + 'z{}_{}_Ifit_impfits_grism'.format(specz, galaxy),fit_dict)
