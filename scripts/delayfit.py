...
def Galfit_prior(u):
    ...
    return [m, a, t, lm, z, d, bp1, rp1, ba, bb, bl, ra, rb, rl, lwa]

def Galfit_L(X):
    #m, a, t, lm, z, d, bsc, rsc, bp1, rp1, ba, bb, bl, ra, rb, rl, lwa = X
    m, a, t, lm, z, d, bp1, rp1, ba, bb, bl, ra, rb, rl, lwa = X
...
params = ['m', 'a', 't', 'lm', 'z', 'd', 'bp1', 'rp1', 'ba', 'bb', 'bl', 'ra', 'rb', 'rl', 'lwa']
...
bfm, bfa, bft, bflm, bfz, bfd, bfbp1, bfrp1, bfba, bfbb, bfbl, bfra, bfrb, bfrl, bflwa= dres.samples[-1]

np.save(pos_path + '{0}_{1}_delayfit_bfit'.format(field, galaxy),
        [bfm, bfa, bft, bflm, bfz, bfd, bfbp1, bfrp1, bfba, bfbb, bfbl, bfra, bfrb, bfrl, bflwa, dres.logl[-1]])
